...
Solucao::Solucao(vector<AviaoTempo> aterragens,double penalizacao,int domTemporal,int maskUpper,int maskLower){
...
Solucao::Solucao(vector<Aviao>& avioes,double penalizacao,int domTemporal){
		this->penalizacao = penalizacao;
		this->domTemporal = domTemporal;
...
Cromossoma* Solucao::obterCopia(){
	return new Solucao(this->aterragens,penalizacao,domTemporal,maskUpper,maskLower);
}
void Solucao::gerarCromo(vector<Aviao>& avioes,int domTemporal){
...
void Solucao::reproduzir(Cromossoma* crom){
	double temp;
	...
	for ( i ; i < h ; i++){
		...
		aterragens[i].tempo = ((Solucao*)crom)->aterragens[i].tempo;
		((Solucao*)crom)->aterragens[i].tempo = temp;
	}
	}
void Solucao::mutar(){
